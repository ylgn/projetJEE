...
<body>
		...
		for(ObjectPAPForClient o : obs)
    {
        ...
        out.print("Objet : " + o.getNameObject());
        out.print("<br/>");
        out.print("Description : " + o.getDescriptionObject());
        out.print("<br/>");
        out.print("Prix : " + o.getPriceObject());
        out.print("<br/>");
        if(o.getIsSelled()){
        	out.print("Vendu !");
        }else{
       ...
       // String object = String.valueOf(o.getNumObject());
       int obn = o.getNumObject();
        ...
        if(!o.getIsSelled()){
        	...
        	out.print("Connectez-vous pour achter l'objet");
        }
