...
public final class loginAns_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
	...
	String passClient = request.getParameter("pass");
      ...
      out.write("\t\t\t\t\t\t<a class=\"logo\" href=\"./View/index.html\">\n");
      ...
      out.write("\t\t\t\t<li class=\"active\">Connexion</li>\n");
      out.write("\t\t\t</ul>\n");
      out.write("\t\t</div>\n");
      out.write("\t</div>\n");
      out.write("\t<!-- /BREADCRUMB -->\n");
      ...
      out.write("\t\t\t\t\t\t\t\t<h3 class=\"title\">connexion</h3>\n");
      out.write("\t\t\t\t\t\t\t</div>\n");
      out.write("\t\t\t\t\t\t\t\t<p>\n");
      out.write("\t\t\t\t\t\t\t\t\t");
 if (erreurDeConnexion == null) { 
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t\t\tBienvenue, <span style=\"color: red;\">");
      out.print( emailClient );
      out.write("</span>!\n");
      out.write("\t\t\t\t\t\t\t\t\t");
}	else { 
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t\t\tErreur, l'adresse ");
      out.print( emailClient );
      out.write(" n'est associée à aucun compte ou le mot de passe est incorrect.</span>\n");
      out.write("\t\t\t\t\t\t\t\t\t");
} 
      out.write("\n");
      out.write("\t\t\t\t\t\t\t\t</p>\n");
